...
public class UI {
    ...
    // UI sounds
    public static final PredefinedSound SOUND_CLICK = new PredefinedSound(Sound.UI_BUTTON_CLICK, 1, 1);
    public static final PredefinedSound SOUND_SUCCESS = new PredefinedSound(Sound.ENTITY_PLAYER_LEVELUP, 1, 1.5f);
    public static final PredefinedSound SOUND_ERROR = new PredefinedSound(Sound.BLOCK_NOTE_BLOCK_BASS, 10.0F, 1.0F);
    public static final PredefinedSound SOUND_DELETE = new PredefinedSound(Sound.ENTITY_ITEM_BREAK, 1, 1);
