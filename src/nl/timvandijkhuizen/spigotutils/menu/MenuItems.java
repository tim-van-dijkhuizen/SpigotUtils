...
public class MenuItems {
    ...
    public static final MenuItemBuilder BACK = new MenuItemBuilder(Material.RED_BED).setName(UI.color("Go back", UI.SECONDARY_COLOR, ChatColor.BOLD));
    ...
    public static final MenuItemBuilder PREVIOUS = new MenuItemBuilder(Material.ARROW).setName(UI.color("Previous page", UI.SECONDARY_COLOR, ChatColor.BOLD));
    public static final MenuItemBuilder NEXT = new MenuItemBuilder(Material.ARROW).setName(UI.color("Next page", UI.SECONDARY_COLOR, ChatColor.BOLD));
